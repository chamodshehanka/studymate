...
class _SundayTabState extends State<SundayTab> {
 ...
 Card makeCard(ScheduleTask sundayTask) => Card(
          ...
          secondaryActions: <Widget>[
            ...
            icon: Icons.delete,
            onTap: ()=> deleteTask(sundayTask),),
            IconSlideAction(caption: 'Update',
            color: Colors.yellowAccent,
            icon: Icons.update,
            onTap: ()=> updateTask(sundayTask,socialActivities,leisureActivities),)
          ],)
 ...
 void deleteTask(ScheduleTask task) {
      ...
      Future<dynamic> isDeleted =
          scheduleService.deleteTask(studentId, "sunday", task.id.toString());
            ...
            Padding(
              ...
              child: StudymateRaisedButton("Add To Schedule", () {
                if (_formKey.currentState.validate()) {
                  ...
                  ScheduleService()
                      .addToSchedule(widget.studentId, scheduleTask, "sunday");
                      Navigator.pop(context);
                }
              }, Colors.deepPurple),
            )
                                ...
                                child: StudymateRaisedButton("Update Task", () {
                                  if (_formKey.currentState.validate()) {
                                    ...
                                    ScheduleTask scheduleTask = new ScheduleTask(
                                     ...
                                     ScheduleService()
                                        .updateTask(widget.studentId, scheduleTask, "sunday");
                                        Navigator.pop(context);
                                  }
                                }, Colors.deepPurple),
                              )
