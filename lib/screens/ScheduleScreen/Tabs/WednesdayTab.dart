...
class _WednesdayTabState extends State<WednesdayTab> {
  ...
  List<ScheduleTask> wednesdayTaskList = List();
  @override
  void initState() {
        super.initState();
...
socialActivitySubscription?.cancel();
 ...
 Card makeCard(ScheduleTask wednesdayTask) => Card(
          elevation: 8.0,
          margin: new EdgeInsets.symmetric(horizontal: 10.0, vertical: 6.0),
          child: Slidable(child: Container(
            decoration: BoxDecoration(color: Colors.deepPurpleAccent),
            child: buildTilesList(wednesdayTask),
          ),
          ...
          secondaryActions: <Widget>[
            ...
            icon: Icons.delete,
            onTap: ()=> deleteTask(wednesdayTask),),
            IconSlideAction(caption: 'Update',
            color: Colors.yellowAccent,
            icon: Icons.update,
            onTap: ()=> updateTask(wednesdayTask,socialActivities,leisureActivities),)
          ],)
         
        );

    final wednesdayTabBody = Container(
      child: ListView.builder(
        scrollDirection: Axis.vertical,
        shrinkWrap: true,
        itemCount: wednesdayTaskList.length,
        itemBuilder: (BuildContext context, int index) {
          return makeCard(wednesdayTaskList[index]);
        },
      ),
    );
    return Scaffold(
      body: wednesdayTabBody,
 ...
 void deleteTask(ScheduleTask task) {
      ...
      Future<dynamic> isDeleted =
          scheduleService.deleteTask(studentId, "wednesday", task.id.toString());
            ...
            Padding(
              ...
              child: StudymateRaisedButton("Add To Schedule", () {
                if (_formKey.currentState.validate()) {
                  ...
                  ScheduleService()
                      .addToSchedule(widget.studentId, scheduleTask, "wednesday");
                      Navigator.pop(context);
                }
              }, Colors.deepPurple),
            )
                                ...
                                child: StudymateRaisedButton("Update Task", () {
                                  if (_formKey.currentState.validate()) {
                                    ...
                                    ScheduleTask scheduleTask = new ScheduleTask(
                                     ...
                                     ScheduleService()
                                        .updateTask(widget.studentId, scheduleTask, "wednesday");
                                        Navigator.pop(context);
                                  }
                                }, Colors.deepPurple),
                              )
