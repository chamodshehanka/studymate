...
class ParentRegisterPage extends StatefulWidget {
  @override
  _ParentRegisterPage createState() => _ParentRegisterPage();
}

class _ParentRegisterPage extends State<ParentRegisterPage> {
  int selectedRadio;
