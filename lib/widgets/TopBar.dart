...
class TopBar extends StatelessWidget{
  Widget build(BuildContext context){
    return CustomPaint(
      ...
      painter: CurvesPainted(),
    );
  }
}

class CurvesPainted extends CustomPainter{
  @override
  ...
  paint.color = Color(0xFF7A36DC).withOpacity(0.2);
  ...
  path = Path();
   ...
   path.quadraticBezierTo(size.width * 0.40,size.height,size.width * 0.50,size.height * 0.80);
  ...
  paint.color = Color(0xFF7A36DC).withOpacity(0.5);
  canvas.drawPath(path, paint);
